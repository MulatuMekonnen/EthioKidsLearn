...
export default function SubtractionScreen() {
  ...
  const generateProblem = () => {
    ...
    const num2 = Math.floor(Math.random() * num1); // 0-(num1-1)
    setCurrentProblem({
      num1,
      num2,
      result: num1 - num2
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: currentTheme?.background || '#1A1B41' }]}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Subtraction</Text>
        <View style={{ width: 40 }} />
      </View>

      <View style={styles.card}>
        <View style={styles.titleBar}>
          <Text style={styles.titleText}>Let's Subtract Numbers!</Text>
        </View>
              ...
              <View style={styles.visualRow}>
                {[...Array(currentProblem.num1)].map((_, i) => (
                  <Image
                    ...
                    style={[
                      styles.ballImage,
                      i >= currentProblem.num1 - currentProblem.num2 && showResult ? styles.removedBall : null
                    ]}
                  />
                ))}
              </View>
                  ...
                  <View style={styles.visualRow}>
                    {[...Array(currentProblem.num2)].map((_, i) => (
                      <Image
                        key={`removed-${i}`}
                        source={require('../../../assets/images/ball.png')}
                        style={[styles.ballImage, styles.removedBall]}
                      />
                    ))}
                  </View>
